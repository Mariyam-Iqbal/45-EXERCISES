...
let personName1: string = "MARIYAM"
...
let inputString:string = "mariyam";
...
let famousQuote: string = "A person who never made a mistake";
...
let person_Name: string = "Mariyam";
let messege: string = "never design your character like a garden where everyone can walk easily";
...
let favouriteNum: number = 5;
let messegeResult: string = `My Lucky Number is:${favouriteNum}`;
...
let mySelf: any = (`${myName} my age is: ${myAge}`);
...
let names:string[] = ["Shabana" , "Dua" , "Zeenat" , "Fizza" , "Mariyam"];
...
let friendsName:string[] = ["Shabana" , "Dua" , "Zeenat" , "Fizza" , "Mariyam"];
//for each
...
let transport: string[] = ["Motorbike" , "Car" , "Cycle" ,"Train"];
//for each
...
let invitation: string [] = ["Fiza", "Kainat", "Sana"];
...
let guestList: string[]= ["Sana", "Kainat", "Fiza"];

//print the name who cant make dinner

let unable: string = guestList.splice(2,2)[0];
...
let bigDinner: string []= ["Sana", "Kainat","Mariyam"];
...
let guestList1:string[]= ["Mariyam", "Kainat","Sana"];
...
let favouritePlaces: string [] = ["Islamabad","Lahore", "Kashmeer","Quetta", "Mansehra","Saudi Arab"];
...
let dinnerInvitaton: string[]= ["Mariyam","Asiya","Shabana","Zeenat","Saba"];
...
let languages: string[] = ["Sindhi", "Urdu", "English","Balochi","Arabic" ];
...
let myArray: (string| number) []= [23, "Mariyam", 2024, "Car"];
...
let userNames: string[]= ["Admin","Mariyam","Sana","Kainat","Shabana","Zeenat"];
...
let userNames2: string[]= ["Admin","Mariyam","Sana","Kainat","Shabana","Zeenat"];
...
function make_shirt2(size: string, label: string){
return size + label
}
...
//making medium as default
  function make_shirt4(label: string, size: string = "Medium"){
    return size + label
    }
   ...
   //for any size
   function make_shirt5(label: string, size: string){
    return size + label
    }
...
function make_album1(artist: string, album: string, numberOfTracks?: number){
...
function carDetails (manufacturer:string, model:string, ...additionalInfor:any){
